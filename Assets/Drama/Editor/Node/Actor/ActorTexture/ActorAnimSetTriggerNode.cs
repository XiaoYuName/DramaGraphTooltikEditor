...
namespace Drama.Editor
{
    ...
    ///
    /// Trigger 没有值，只有"触发"这个动作，所以比其它三个少一个值端口，
    /// 多一个「方式」选项来区分设置和撤销（理由见 <see cref="EAnimTriggerMode"/>）。
    /// </summary>
    [System.Serializable]
    [Node("命令/立绘/Animator","Assets/Drama/Assets/Event.png","触发Trigger")]
    public class ActorAnimSetTriggerNode : ActorAnimParameterNode
    {
